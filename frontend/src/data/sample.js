export const SAMPLE = {
  ...
  lunch: {
    ...
    rules: [
      { id: 'l1', on: true, name: "본관 학생식당 — 평일 11:30",
        sub: "메뉴 + 주변 음식점 3+ · 예산 ₩9,000 이하",
        conds: [
          { k: "식당", v: "본관 A" }, { k: "시각", v: "11:30" },
          { k: "요일", v: "월–금" }, { k: "예산", v: "≤ ₩9,000" },
        ]},
  ...
  feed: [
    ...
    { time: "10:42:18", kind: "TRANSIT", title: "신촌역 2호선",         detail: "내선순환 도착 3분 전 · 혼잡도 보통" },
    { time: "09:58:44", kind: "LIBRARY", title: "제 4 열람실 잔여 23석", detail: "임계값 25석 이하 도달" },
    { time: "08:21:04", kind: "TRANSIT", title: "신촌역 2호선",         detail: "내선순환 도착 3분 전 · 혼잡도 여유" },
  ...
  history: [
    { time: "05-13 11:30", kind: "LUNCH",   title: "본관 학생식당 메뉴",     detail: "추천: 소담 / 비빔국수 ₩7,500" },
    { time: "05-13 10:42", kind: "TRANSIT", title: "신촌역 2호선 내선순환",  detail: "도착 3분 전 / 보통 / 지연 0분" },
    { time: "05-13 09:58", kind: "LIBRARY", title: "제 4 열람실 잔여 23석",  detail: "임계 25석 이하" },
    { time: "05-13 08:21", kind: "TRANSIT", title: "신촌역 2호선 내선순환",  detail: "도착 3분 전 / 여유" },
    { time: "05-12 22:14", kind: "LIBRARY", title: "긴급 · 제 4 열람실 8석", detail: "긴급 임계 도달" },
    { time: "05-12 18:15", kind: "TRANSIT", title: "강남역 9호선",           detail: "정기 간격 알림 / 혼잡" },
    ...
    { time: "05-11 11:30", kind: "LUNCH",   title: "본관 학생식당 메뉴",     detail: "추천: 소담 / 김밥 ₩4,500" },
